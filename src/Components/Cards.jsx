...
const Cards = () => {
  return (
    <div className='w-full bg-zinc-900 h-screen items-center flex gap-5 p-5'>
        <div className="card-container h-[50vh] w-1/2 ">
            <div className="card relative rounded-xl w-full h-full bg-[#004D43] justify-center items-center flex">
            <a className="inline-flex" href="https://ochi.design">
                            ...
                            <button className='absolute left-2 bottom-5 px-5 py-1 border-2 rounded-full'>©2019-2024</button>
            </div>
        </div>
        <div className="card-container flex gap-5 h-[50vh] w-1/2 ">
            <div className="relative card rounded-xl w-full h-full bg-[#182a28] flex justify-center items-center ">
<img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
                <button className='absolute left-2 bottom-5 px-5 py-1 border-2 rounded-full uppercase text-sm'>rating 5.0 on clutch</button>
            </div>
            <div className="card relative rounded-xl w-full flex justify-center items-center h-full bg-[#182a28]">
<img style={{height:"90px"}}src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
            <button className='absolute left-2 bottom-5 px-5 py-1 border-2 rounded-full uppercase text-sm'>buisness bootcamp alumni</button>
            </div>
